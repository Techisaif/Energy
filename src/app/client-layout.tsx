        ...
        <footer className="energy-footer bg-black/80 backdrop-blur-lg border-t border-blue-900/30 pt-16 pb-8">
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="footer-section">
                <h4 className="text-xl font-bold mb-4 text-blue-400">Contact Nexus</h4>
                <p className="text-gray-300 mb-2">innovation@futureenergyhub.io</p>
                <p className="text-gray-300 mb-4">+1 (555) 202-7070</p>
            ...
            <div className="copyright text-center border-t border-blue-900/30 pt-8">
              <p className="text-gray-400 mb-2">© 2025 Future Energy Hub | Synthesizing Sustainable Futures</p>
              <p className="text-gray-500 text-sm">All visualizations and projections dynamically generated by Athena AI systems</p>
            </div>
          </div>
        </footer>
